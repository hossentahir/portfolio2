...
import { LogOut, FolderGit2, BookOpen, User, ShieldCheck } from 'lucide-react';
import toast from 'react-hot-toast';
import { BlogManager } from '../components/admin/BlogManager';
import { ProjectManager } from '../components/admin/ProjectManager';

export const AdminDashboard = () => {
  const [activeTab, setActiveTab] = useState('blogs'); // 'blogs' | 'projects'
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Administration dashboard for managing projects and blog posts." />
      </Helmet>
